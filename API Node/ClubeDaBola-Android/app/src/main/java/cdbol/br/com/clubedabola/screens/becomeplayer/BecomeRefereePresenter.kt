...
class BecomeRefereePresenter : BaseMvpPresenterImpl<BecomePlayerContract.View>(),
   ...
   // private var address : String = ""
    ...
    override fun buildDataPlayer(type: String) {
         var dataPlayer = GoalKeeperRequest(
                 PreferencesString.getInstance(mView!!.getContext()).getString("hirerId")!!,
                this.gender,
                this.gloveSize,
                this.tshirtSize,
                ...
                this.phone,
                 "",
                 PreferencesString.getInstance(mView!!.getContext()).getString("nickName")!!+ ".png",
                 true,
                 10
        )
    ...
    private fun postDigitalWallet(){
        var request = DigitalWalletResquest(PreferencesString.getInstance(mView!!.getContext()).getString("hirerId")!!)
    ...
    private fun getHirerId(){
        ApiManager.getHirerById(PreferencesString.getInstance(mView!!.getContext()).getString("hirerId")!!)
