...
class ItemProfileAdapter(private var items: ArrayList<ItemProfile>, private val listener: (Int) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    companion object {
        const val TYPE_AMOUNT = 0
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        when(getItemViewType(viewType)){
            TYPE_AMOUNT -> layout = R.layout.item_profile
            TYPE_OTHERS -> layout = R.layout.item_profile_others
