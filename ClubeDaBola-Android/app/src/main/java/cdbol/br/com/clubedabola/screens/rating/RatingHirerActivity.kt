...
class RatingHirerActivity : BaseMvpActivity<RatingContract.View, RatingContract.Presenter>() {

    override var mPresenter: RatingContract.Presenter = RatingPresenter()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_rating_hirer)
        initToolBar()
    ...
    fun callPutRatingMatch(){
        ...
        var rating = rb_first.rating + rb_second.rating
